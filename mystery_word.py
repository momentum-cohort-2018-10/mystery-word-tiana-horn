...
def get_difficulty():
    """ Requests a game difficulty level from the user
    """
    difficulty = input("Would you like to play the easy, normal or hard mode? ").lower()
    return difficulty

def get_word_length(difficulty):
    """ Determines the length of the word to guess based on the users
...
def mystery():
    ...
    that allows users to select difficulty and guess a word 
    """   
